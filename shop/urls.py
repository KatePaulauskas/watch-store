...
from . import views
from .views import cancel_action, cancel_action_product_page, cancel_action_manage_products
...
urlpatterns = [
    ...
    path('manage_products/cancel/', cancel_action_manage_products, name='cancel_action_manage_products'),
]