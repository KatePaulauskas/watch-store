...
class Order(models.Model):
    ...
    delivery_method = models.ForeignKey(
        DeliveryMethod, on_delete=models.PROTECT, null=True, blank=True)
    delivery_cost = models.DecimalField(
        max_digits=12, decimal_places=2, null=False, default=0)
    add_ons = models.ManyToManyField(
        AddOn, blank=True, related_name='orders')
    add_ons_cost = models.DecimalField(
        max_digits=12, decimal_places=2, null=False, default=0)
    ...
    def update_total(self):
        ...
        for delivery costs and add-ons.
        """
